...
class _CommandRoof:
    ...
    def GetResources(self):
        ...
        return {'Pixmap'  : 'Arch_Roof2',
                'MenuText': QT_TRANSLATE_NOOP("Arch_Roof2","Roof2"),
                'Accel': "R, F",
                'ToolTip': QT_TRANSLATE_NOOP("Arch_Roof2","Creates a roof object from the selected wire22."),
                }
    ...
    def Activated(self):
        ...
        if sel:
            ...
            FreeCAD.ArchObserver = ArchComponent.ArchSelectionObserver(nextCommand="Arch_Roof2")
...
class _ViewProviderRoof(ArchComponent.ViewProviderComponent):
    ...
    def getIcon(self):
        ...
        import Arch_rc
        return ":/icons/Arch_Roof2_Tree.svg"
